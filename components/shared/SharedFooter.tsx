            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 relative z-10 w-full">
                ...
                <div className="col-span-1 md:col-span-1 lg:col-span-3 lg:col-start-10 pt-4">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        <a aria-label="LinkedIn" className="aspect-square rounded-2xl bg-gray-50 dark:bg-gray-800 flex items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-[#0077b5] hover:text-white transition-all group" href="https://linkedin.com/in/swarn-shauryam" target="_blank" rel="noopener noreferrer">
                        ...
                        <a aria-label="Instagram" className="aspect-square rounded-2xl bg-gray-50 dark:bg-gray-800 flex items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-[#E1306C] hover:text-white transition-all group" href="https://www.instagram.com/ajai.swarn/" target="_blank" rel="noopener noreferrer">
                        ...
                        <a aria-label="YouTube" className="aspect-square rounded-2xl bg-gray-50 dark:bg-gray-800 flex items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-[#FF0000] hover:text-white transition-all group" href="https://www.youtube.com/@ajaiswarn" target="_blank" rel="noopener noreferrer">
